...
3. Decision: Formulate the final "instruction"."""
            ...
            if has_question:
                ...
                text_content += """\n\nFormat response:
<answer>{"location": "<1-2 words, e.g., road, restaurant>", "weather": "<1 word, e.g., sunny, night>", "traffic": "<1 word, e.g., moderate, high>", "scene": "<concise visual summary, max 2 sentences>", "instruction": "<your answer to the question>"}</answer>"""
            else:
                text_content += """\n\nFormat response:
<answer>{"location": "<1-2 words, e.g., road, restaurant>", "weather": "<1 word, e.g., sunny, night>", "traffic": "<1 word, e.g., moderate, high>", "scene": "<concise visual summary, max 2 sentences>", "instruction": "<actionable alert and guidance>"}</answer>"""
