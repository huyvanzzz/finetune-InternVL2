...
def test_concat_case1_config_targets_label_smoothing_only():
    cfg = yaml.safe_load((ROOT / "internvl_config_traj_concat_case1_label_smoothing.yaml").read_text(encoding="utf-8"))
